    ...
    <div class="row justify-content-center">
        <div class="container-fluid mt-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    <h4 class="form-title">Form Edit Assurance</h4>
                    <form action="{{ route('assurance.update',$assurance->assurance_id) }}" method="POST" enctype="multipart/form-data"
                        name="deploymentAdd">
                        @csrf
                        @method('put')
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input type="form-input" name="incident" id="incident" class="form-control"
                                value="{{ $assurance->incident }}">  
                            </div>
                            <div class="col">
                                <label for="olo">OLO / ISP</label>
                                <select name="olo_id" id="olo_id" class="form-control" required>
                                <option value="{{ $assurance->olo_id }}">{{ $assurance->olo_tabel->olo_nama }}</option>
                        ...
                        <div class="form-row mt-3">
                            ...
                            <div class="col">
                                ...
                                value="{{$assurance->last_updated_work_log}}">
                            </div>
                            <div class="col">
                        ...
                        <div class="form-row mt-3">
                            <div class="col">
                                ...
                                value="{{$assurance->external_ticket_status}}">
                            </div>
                            <div class="col">
                                <label for="channel">Channel</label>
                                <input type="form-control" name="channel" id="channel" class="form-control"  value="{{$assurance->channel}}">
                            </div>
                            <div class="col">
                        ...
                        <div class="form-row mt-3">
                                <div class="col">
                                    ...
                                    <input type="form-control" name="customer_id" id="customer_id" class="form-control" value="{{$assurance->customer_id}}">
                                </div>
                                <div class="col">
                                    <label for="service_id">Service ID</label>
                                    <input type="form-control" name="service_id" id="service_id" class="form-control" value="{{$assurance->service_id}}">
                                </div>
                        ...
                        <div class="form-row">     
                            ...
                            <div class="col">
                                ...
                                value="{{$assurance->last_update_ticket}}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                ...
                                <option value="{{$assurance->witel_id}}">{{$assurance->witel_tabel->witel_nama}}</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                ...
                                <option value="{{$assurance->incident_domain_id}}">{{$assurance->incident_domain_tabel->incident_domain_nama}}</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                ...
                                value="{{$assurance->kode_produk}}">
                            </div>
                            <div class="col">
                                <label for="resolved_date">Resolved Date</label>
                                <input type="datetime" name="resolved_date" id="resolved_date" class="form-control"
                                value="{{$assurance->resolved_date}}">
                            </div>
                        </div>
