                    ...
                    <form action="{{ route('dep.update', $deployment->deployment_id) }}}" method="POST" >
                        ...
                        <div class="form-row mt-3">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-7">
                                    ...
                                    <input type="date" name="tanggal_integrasi" id="tanggal_integrasi_b" class="form-control"
                        ...
                        <div class="form-row mt-3">
                            ...
                            <label for="metro_1">METRO BACKHAUL</label>
                                <input type="text" name="metro_1" id="metro_1" class="form-control" value="{{ $deployment->metro_1 }}">
                                </input>
                            </div>
                            <div class="col">
                        ...
                        <div class="form-row mt-3">
                            <div class="col">
                                ...
                                <input type="text" name="ip_3" id="ip_3" class="form-control" value="{{ $deployment->ip_3 }}">
                                </div>
                            <div class="col">
                        ...
                        <div class="form-row mt-3">
                            <div class="col">
                                ...
                                <textarea class="form-control" name="kontak_pic_lokasi" id="kontak_pic_lokasi" value="{{ $deployment->kontak_pic_lokasi }}" rows="3">
                                    {{ $deployment->kontak_pic_lokasi }}</textarea>
                            </div>
                            <div class="col">
                        ...
                        <div class="form-row mt-3">
                            <div class="col">
                                ...
                                <input class="form-control" name="type_2" id="type_2"
                                    rows="3" values="{{ $deployment->type_2}}">{{ $deployment->type_2}}</input>
                            </div>
                        </div>
